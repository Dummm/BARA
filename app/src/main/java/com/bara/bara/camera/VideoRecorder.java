...
//    Log.d(TAG, "asdf startRecordingVideo: " + encoderSurface.toString());
//    Log.d(TAG, "asdf startRecordingVideo: " + videoSize.getWidth() + ", " + videoSize.getHeight());
...
//    mediaRecorder.setProfile(CamcorderProfile.get(CamcorderProfile.QUALITY_HIGH));
    ...
    try {
      ...
      Log.e(TAG, "asdf Exception preparing capture: " + e.getMessage(), e);
    }
